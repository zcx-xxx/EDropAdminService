...
<div class="ui_content" id="updatediv">
		...
		<table class="table" cellspacing="0" cellpadding="0" width="100%"
			...
			<c:forEach items="${pageInfo.list }" var="p">
				<tr>
					...
					<td><a href="house_edit.html?fyID=14458579642011" class="edit">编辑</a>
	...
	<div class="ui_tb_h30">
		<div class="ui_flt" style="height: 30px; line-height: 30px;">
			共有 <span class="ui_txt_bold04">${pageInfo.total }</span> 条记录，当前第 <span
				class="ui_txt_bold04">${pageInfo.pageNum } / ${pageInfo.pages }</span>
			页
		</div>
		<div class="ui_frt">
			<!--    如果是第一页，则只显示下一页、尾页 -->
			...
			<c:if test="${pageInfo.pageNum > 1 }">
				<input type="button" value="上一页" class="ui_input_btn01"
					onclick="jumpNormalPage(${pageInfo.pageNum-1 });" />
			</c:if>
