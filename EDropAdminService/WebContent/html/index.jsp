...
<base href="<%=basePath %>>">
	...
	<link href="html/style/authority/zTreeStyle.css" rel="stylesheet" type="text/css">
		...
		function addfavorite(){
			var ua = navigator.userAgent.toLowerCase();
			 if (ua.indexOf("360se") > -1){
			  	...
			  	window.external.AddToFavoritesBar('${dynamicURL}/authority/loginInit.action','EDrop后台信息管理系统');//IE8
			 }else if (document.all){
			  	window.external.addFavorite('${dynamicURL}/authority/loginInit.action','EDrop后台信息管理系统');
			 }else{
		...
		function loadMenu(resourceType, treeObj){
			/*$.ajax({
			 ...
			 data = [{"accessPath":"","checked":false,"delFlag":0,"parentID":1,"resourceCode":"","resourceDesc":"","resourceGrade":2,"resourceID":3,"resourceName":"用户管理","resourceOrder":0,"resourceType":""},
		            ...
		            {"accessPath":"html/community.jsp","checked":false,"delFlag":0,"parentID":55,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":44,"resourceName":"添加文章","resourceOrder":0,"resourceType":""},
		            {"accessPath":"rubbish/list","checked":false,"delFlag":0,"parentID":24,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":26,"resourceName":"垃圾信息管理","resourceOrder":0,"resourceType":""},
		            {"accessPath":"order/list","checked":false,"delFlag":0,"parentID":16,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":17,"resourceName":"所有订单","resourceOrder":0,"resourceType":""},
		            ...
		            {"accessPath":"","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":32,"resourceName":"反馈处理","resourceOrder":0,"resourceType":""},
...
<body onload="getDate01()">
    <div id="top">
		<div id="top_logo">
			<img alt="logo" src="html/images/common/logo.jpg" width="274" height="49" style="vertical-align:middle;">
		</div>
		<div id="top_links">
			<div id="top_op">
				<ul>
					...
					<li>
						<img alt="今天是" src="html/images/common/date.jpg">：
			...
			<div id="top_close">
				<a href="javascript:void(0);" onclick="logout();" target="_parent">
					<img alt="退出系统" title="退出系统" src="html/images/common/close.jpg" style="position: relative; top: 10px; left: 25px;">
				</a>
			</div>
		</div>
	</div>
		...
		<div id="left_menu">
		 	<ul id="TabPage2" style="height:200px; margin-top:50px;">
				<li id="left_tab1" class="selected" onClick="javascript:switchTab('TabPage2','left_tab1');" title="业务模块">
					<img alt="业务模块" title="业务模块" src="html/images/common/1_hover.jpg" width="33" height="31">
				</li>
				<li id="left_tab2" onClick="javascript:switchTab('TabPage2','left_tab2');" title="系统管理">
					<img alt="系统管理" title="系统管理" src="html/images/common/2.jpg" width="33" height="31">
				</li>		
				<li id="left_tab3" onClick="javascript:switchTab('TabPage2','left_tab3');" title="其他">
					<img alt="其他" title="其他" src="html/images/common/3.jpg" width="33" height="31">
				</li>
			</ul>
			...
			<div id="nav_show" style="position:absolute; bottom:0px; padding:10px;">
				<a href="javascript:;" id="show_hide_btn">
					<img alt="显示/隐藏" title="显示/隐藏" src="html/images/common/nav_hide.png" width="35" height="35">
				</a>
			</div>
		 </div>
		 <div id="left_menu_cnt">
		 	<div id="nav_module">
		 		<img src="html/images/common/module_1.png" width="210" height="58"/>
		 	</div>
		 	<div id="nav_resource">
	...
	<script type="text/javascript">
		$(function(){
			$('#TabPage2 li').click(function(){
				...
				$(this).find('img').attr('src', 'html/images/common/'+ (index+1) +'_hover.jpg');
				$(this).css({background:'#fff'});
				$('#nav_module').find('img').attr('src', 'html/images/common/module_'+ (index+1) +'.png');
				$('#TabPage2 li').each(function(i, ele){
					if( i!=index ){
						$(ele).find('img').attr('src', 'html/images/common/'+ (i+1) +'.jpg');
		...
		function switchSysBar(flag){
			...
			if( flag==true ){	// flag==true
		        ...
		        if ( left_menu_cnt.is(":visible") ) {
		        	...
		        	$('#main').css({left:'60px'});
		        	$("#show_hide_btn").find('img').attr('src', 'html/images/common/nav_show.png');
		        } else {
					left_menu_cnt.show(500, 'linear');
					side.css({width:'280px'});
					$('#top_nav').css({width:'77%', left:'304px', 'padding-left':'0px'});
		        	$('#main').css({left:'280px'});
		        	$("#show_hide_btn").find('img').attr('src', 'html/images/common/nav_hide.png');
		        }
			}
		}
	</script>
