...
<script type="text/javascript">
	$(function(){
		$("#find_order").click(function(){
			...
			var outelephone = $("#outelephone").val();
			$.ajax({
				type: "POST",
				url: "order/find",
				data: "number=" + number +"&ouname=" + ouname + "&outelephone=" + outelephone,
				dataType : "html",
				cache:false,
...
// 				return;
	...
	function jumpNormalPage(page){
		$("#submitForm").attr("action", "order/list?page=" + page).submit();
	}
	...
	function jumpInputPage(totalPage){
		...
		if($("#jumpNumTxt").val() != ''){
			...
			$("#submitForm").attr("action", "order/list?page=" + pageNum).submit();
		}else{
			// “跳转页数”为空
			art.dialog({icon:'error', title:'友情提示', drag:false, resize:false, content:'请输入合适的页数，\n自动为您跳到首页', ok:true,});
			$("#submitForm").attr("action", "order/list?page=" + 1).submit();
		}
	}
</script>
<style>
			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							订单编号&nbsp;&nbsp;<input type="text" id="number" name="number" class="ui_input_txt02" />
							联系人&nbsp;&nbsp;<input type="text" id="ouname" name="ouname" class="ui_input_txt02" />
							电话&nbsp;&nbsp;<input type="text" id="outelephone" name="outelephone" class="ui_input_txt02" />
						</div>
						<div id="box_bottom">
							<input type="button" value="查询" class="ui_input_btn01" id="find_order"/> 
